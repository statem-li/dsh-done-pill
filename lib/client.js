...
function DonePill(props) {
  ...
  const [clockTick, setClockTick] = (0, import_react.useState)(0);
  (0, import_react.useEffect)(() => {
  ...
  if (lateActive) {
    ...
    reminderLabel = hour <= 4 ? `\u51CC\u6668 ${hour} \u70B9 ${nowDate.getMinutes()} \u5206 ${nowDate.getSeconds()} \u79D2\uFF0C\u6CE8\u610F\u4F11\u606F` : `${hour >= 22 ? "\u591C\u6DF1\u4E86" : `\u5DF2 ${hour} \u70B9`}\uFF0C\u6CE8\u610F\u4F11\u606F`;
  } else if (restActive) {
    reminderIcon = "coffee";
